...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Seguro Simple</a>
            <small>Sistema de Cotizacion de Autos</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="LoginController">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="txtNombre" placeholder="Username" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="txtAction" value="registrarCliente" />
                        </form>
                    </div>
